...
import { Code, Server, Terminal, ShieldCheck, CheckCircle2 } from 'lucide-react';
import { ServiceContactForm } from '../components/ServiceContactForm';

const ServiceCustomSoftwarePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      <section className="pt-48 pb-32 px-6 md:px-20 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <h1 className="text-6xl md:text-9xl font-black text-slate-900 leading-[0.85] tracking-tighter mb-10 uppercase">
            Custom <br /><span className="text-blue-600">Software.</span>
          </h1>
          <p className="text-xl md:text-3xl text-slate-500 max-w-3xl font-light leading-relaxed">
            Off-the-shelf solutions are for standard problems. For your unique business edge, we build custom software that aligns perfectly with your operations and future vision.
          </p>
        </div>
      </section>
          ...
          {[
            {
              ...
              desc: "Unified business management systems designed for your specific vertical.",
              icon: <Server className="w-8 h-8 text-blue-600" />
            },
            {
              title: "Legacy Refresh",
              desc: "Modernizing core systems without data loss or operational downtime.",
              icon: <Terminal className="w-8 h-8 text-indigo-600" />
            },
            {
              title: "FinTech Engines",
              desc: "Secure, high-throughput payment and ledger systems built on modern cloud.",
      ...
      <section className="py-32 px-6 md:px-20 bg-slate-950 text-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-4xl md:text-6xl font-black mb-10 tracking-tighter uppercase">Crafted <br/><span className="text-blue-600">Precision</span></h2>
            <div className="space-y-8">
              {[
                "Modular & Maintainable Codebases",
                "Comprehensive API Documentation",
                "Full-Spectrum Unit & Integration Tests",
          ...
          <div className="rounded-[4rem] overflow-hidden shadow-2xl">
            <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=1200&q=80" alt="Custom Software" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="py-32 px-6 md:px-20 bg-white">
        <div className="max-w-4xl mx-auto">
          <ServiceContactForm defaultService="Custom Software" />
        </div>
      </section>
    </div>
  );
...
export default ServiceCustomSoftwarePage;